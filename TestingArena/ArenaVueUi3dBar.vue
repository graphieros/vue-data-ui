...
const model = createModel([
    ...
    NUMBER('style.chart.bar.strokeWidth', {
        def: 1,
        min: 0,
        max: 12,
        step: 0.5,
    ...
    NUMBER('style.chart.box.strokeWidth', {
        def: 1,
        min: 0,
        max: 12,
        step: 0.5,
    ...
    NUMBER('style.chart.box.dimensions.height', {
        def: 256,
        min: 64,
        max: 600,
    }),
    ...
    NUMBER('style.chart.box.dimensions.perspective', {
        def: 18,
        min: 0,
        max: 100,
    }),
    ...
    NUMBER('style.chart.legend.hideUnderPercentage', {
        def: 3,
        min: 1,
        max: 20,
    }),
...
<template>
    ...
    <select v-model="selectedDataset" @change="step += 1">
