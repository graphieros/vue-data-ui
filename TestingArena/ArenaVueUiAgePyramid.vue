...
const model = createModel([
    ...
    NUMBER('style.layout.dataLabels.sideTitles.fontSize', {
        def: 18,
        min: 8,
        max: 48,
    }),
    ...
    NUMBER('style.layout.dataLabels.sideTitles.offsetY', {
        def: 0,
        min: -100,
        max: 100,
    }),
    ...
    RANGE('style.layout.dataLabels.xAxis.scale', {
        def: 1000,
        min: 100,
        max: 10000,
    }),
    TEXT('style.layout.dataLabels.xAxis.translation', { def: 'in thousands' }),
    NUMBER('style.layout.dataLabels.xAxis.autoRotate.angle', {
        def: -90,
        min: -90,
        max: 90,
    }),
    ...
    SELECT('style.layout.dataLabels.yAxis.display', ['age', 'year'], {
        def: 'age',
    }),
    ...
    RANGE('style.layout.dataLabels.yAxis.showEvery', {
        def: 5,
        min: 1,
        max: 100,
    }),
    ...
    RANGE('style.layout.bars.gradient.intensity', {
        def: 60,
        min: 0,
        max: 100,
    }),
    NUMBER('style.layout.bars.gradient.shiftHue', {
        def: 0.05,
        min: 0,
        max: 1,
        step: 0.01,
