...
const model = createModel([
    ...
    RANGE('style.chart.animation.animationFrames', {
        def: 60,
        min: 30,
        max: 255,
    }),
    ...
    NUMBER('style.chart.segments.dataLabels.fontSize', {
        def: 10,
        min: 8,
        max: 42,
    }),
    ...
    NUMBER('style.chart.segments.dataLabels.offsetY', {
        def: 0,
        min: -50,
        max: 50,
    }),
    ...
    NUMBER('style.chart.segments.ticks.divisions', {
        def: 10,
        min: 2,
        max: 20,
    }),
    ...
    RANGE('style.chart.target.heightRatio', {
        def: 0.8,
        min: 0.2,
        max: 1,
        step: 0.01,
    ...
    RANGE('style.chart.valueBar.heightRatio', {
        def: 0.33,
        min: 0.2,
        max: 1,
        step: 0.01,
