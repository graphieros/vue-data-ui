...
const model = createModel([
    ...
    RANGE('style.layout.grid.strokeWidth', {
        def: 1,
        min: 0,
        max: 12,
        step: 0.5,
    ...
    NUMBER('style.layout.grid.horizontalLines.strokeDasharray', {
        def: 3,
        min: 0,
        max: 12,
    }),
    COLOR('style.layout.grid.horizontalLines.stroke', { def: '#FF0000' }),
    NUMBER('style.layout.grid.horizontalLines.strokeWidth', {
        def: 0.5,
        min: 0,
        max: 12,
        step: 0.1,
    ...
    NUMBER('style.layout.grid.verticalLines.strokeDasharray', {
        def: 3,
        min: 0,
        max: 12,
    }),
    COLOR('style.layout.grid.verticalLines.stroke', { def: '#0000FF' }),
    NUMBER('style.layout.grid.verticalLines.strokeWidth', {
        def: 0.5,
        min: 0,
        max: 12,
        step: 0.1,
    ...
    NUMBER('style.layout.grid.xAxis.dataLabels.fontSize', {
        def: 10,
        min: 4,
        max: 12,
    }),
    COLOR('style.layout.grid.xAxis.dataLabels.color', { def: '#1A1A1A' }),
    NUMBER('style.layout.grid.xAxis.dataLabels.offsetY', {
        def: 0,
        min: -100,
        max: 100,
    }),
    CHECKBOX('style.layout.grid.xAxis.dataLabels.bold', { def: false }),
    NUMBER('style.layout.grid.xAxis.dataLabels.rotation', {
        def: -20,
        min: -360,
        max: 360,
    }),

    CHECKBOX('style.layout.grid.xAxis.dataLabels.autoRotate.enable', {
        def: true,
    }),
    NUMBER('style.layout.grid.xAxis.dataLabels.autoRotate.angle', {
        def: -90,
        min: -90,
        max: 90,
    }),
    ...
    NUMBER('style.layout.grid.yAxis.dataLabels.fontSize', {
        def: 10,
        min: 4,
        max: 12,
    }),
    COLOR('style.layout.grid.yAxis.dataLabels.color', { def: '#1A1A1A' }),
    NUMBER('style.layout.grid.yAxis.dataLabels.offsetX', {
        def: 0,
        min: -100,
        max: 100,
    }),
    CHECKBOX('style.layout.grid.yAxis.dataLabels.bold', { def: false }),
    NUMBER('style.layout.grid.yAxis.dataLabels.steps', {
        def: 10,
        min: 2,
        max: 20,
    }),
    ...
    NUMBER('style.layout.grid.yAxis.scale.max', {
        def: null,
        min: 0,
        max: 10000,
    }),
    ...
    NUMBER('style.layout.wick.strokeWidth', {
        def: 0.5,
        min: 0,
        max: 12,
        step: 0.5,
    ...
    SELECT('style.layout.wick.extremity.shape', ['line', 'circle'], {
        def: 'line',
    }),
    SELECT('style.layout.wick.extremity.size', ['auto', 5, 10, 20, 40], {
        def: 'auto',
    }),
    ...
    NUMBER('style.layout.candle.strokeWidth', {
        def: 0.5,
        min: 0.5,
        max: 12,
        step: 0.5,
    ...
    RANGE('style.layout.candle.gradient.intensity', {
        def: 40,
        min: 0,
        max: 100,
    }),
    ...
    NUMBER('style.layout.candle.widthRatio', {
        def: 0.5,
        min: 0.1,
        max: 1,
        step: 0.1,
    ...
    NUMBER('style.zoom.focusRangeRatio', {
        def: 0.2,
        min: 0.1,
        max: 0.9,
        step: 0.1,
