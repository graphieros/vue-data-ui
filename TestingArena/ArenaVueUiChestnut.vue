...
const model = createModel([
    ...
    NUMBER('style.chart.layout.grandTotal.fontSize', {
        def: 20,
        min: 8,
        max: 48,
    }),
    ...
    NUMBER('style.chart.layout.grandTotal.roundingValue', {
        def: 2,
        min: 0,
        max: 12,
    }),
    ...
    NUMBER('style.chart.layout.grandTotal.offsetY', {
        def: 0,
        min: -100,
        max: 100,
    }),
    ...
    RANGE('style.chart.layout.roots.gradientIntensity', {
        def: 20,
        min: 0,
        max: 100,
    }),
    ...
    RANGE('style.chart.layout.roots.labels.fontSize', {
        def: 16,
        min: 8,
        max: 48,
    }),
    CHECKBOX('style.chart.layout.roots.labels.adaptColorToBackground', {
        def: true,
    }),
    COLOR('style.chart.layout.roots.labels.color', { def: '#FFFFFF' }),
    CHECKBOX('style.chart.layout.roots.labels.bold', { def: true }),
    NUMBER('style.chart.layout.roots.labels.roundingValue', {
        def: 2,
        min: 0,
        max: 12,
    }),
    ...
    NUMBER('style.chart.layout.roots.labels.name.fontSize', {
        def: 16,
        min: 8,
        max: 48,
    }),
    ...
    RANGE('style.chart.layout.verticalSeparator.strokeWidth', {
        def: 5,
        min: 0,
        max: 24,
    }),
    ...
    NUMBER('style.chart.layout.branches.strokeWidth', {
        def: 0,
        min: 0,
        max: 12,
    }),
    RANGE('style.chart.layout.branches.borderRadius', {
        def: 6,
        min: 0,
        max: 24,
    }),
    CHECKBOX('style.chart.layout.branches.useGradient', { def: true }),
    RANGE('style.chart.layout.branches.gradientIntensity', {
        def: 20,
        min: 0,
        max: 100,
    }),
    COLOR('style.chart.layout.branches.underlayerColor', { def: '#FFFFFF' }),
    RANGE('style.chart.layout.branches.widthRatio', {
        def: 1.5,
        min: 0.1,
        max: 2,
        step: 0.01,
    ...
    RANGE('style.chart.layout.branches.labels.fontSize', {
        def: 14,
        min: 8,
        max: 48,
    }),
    ...
    CHECKBOX('style.chart.layout.branches.labels.dataLabels.show', {
        def: true,
    }),
    NUMBER('style.chart.layout.branches.labels.dataLabels.hideUnderValue', {
        def: 5,
        min: 1,
        max: 20,
    }),
    RANGE('style.chart.layout.branches.labels.dataLabels.fontSize', {
        def: 14,
        min: 8,
        max: 48,
    }),
    NUMBER('style.chart.layout.branches.labels.dataLabels.roundingValue', {
        def: 2,
        min: 0,
        max: 12,
    }),
    NUMBER('style.chart.layout.branches.labels.dataLabels.roundingPercentage', {
        def: 2,
        min: 0,
        max: 12,
    }),
    ...
    RANGE('style.chart.layout.nuts.gradientIntensity', {
        def: 30,
        min: 0,
        max: 100,
    }),
    ...
    RANGE('style.chart.layout.nuts.selected.gradientIntensity', {
        def: 40,
        min: 0,
        max: 100,
    }),
    NUMBER('style.chart.layout.nuts.selected.roundingValue', {
        def: 2,
        min: 0,
        max: 12,
    }),
    NUMBER('style.chart.layout.nuts.selected.roundingPercentage', {
        def: 2,
        min: 0,
        max: 12,
    }),
    ...
    NUMBER(
        'style.chart.layout.nuts.selected.labels.dataLabels.hideUnderValue',
        {
            def: 5,
            min: 1,
            max: 20,
    ...
    COLOR('style.chart.layout.nuts.selected.labels.dataLabels.color', {
        def: '#1A1A1A',
    }),
    NUMBER('style.chart.layout.nuts.selected.labels.dataLabels.fontSize', {
        def: 12,
        min: 8,
        max: 48,
    }),
    CHECKBOX('style.chart.layout.nuts.selected.labels.dataLabels.bold', {
        def: true,
    }),
    TEXT('style.chart.layout.nuts.selected.labels.dataLabels.prefix', {
        def: 'P',
    }),
    TEXT('style.chart.layout.nuts.selected.labels.dataLabels.suffix', {
        def: 'S',
    }),

    COLOR('style.chart.layout.nuts.selected.labels.core.total.color', {
        def: '#1A1A1A',
    }),
    NUMBER('style.chart.layout.nuts.selected.labels.core.total.fontSize', {
        def: 24,
        min: 8,
        max: 48,
    }),
    CHECKBOX('style.chart.layout.nuts.selected.labels.core.total.bold', {
        def: false,
    }),

    COLOR('style.chart.layout.nuts.selected.labels.core.value.color', {
        def: '#1A1A1A',
    }),
    NUMBER('style.chart.layout.nuts.selected.labels.core.value.fontSize', {
        def: 24,
        min: 8,
        max: 48,
    }),
    CHECKBOX('style.chart.layout.nuts.selected.labels.core.value.bold', {
        def: true,
    }),
    TEXT('style.chart.layout.nuts.selected.labels.core.value.prefix', {
        def: 'P',
    }),
    TEXT('style.chart.layout.nuts.selected.labels.core.value.suffix', {
        def: 'S',
    }),

    NUMBER('style.chart.layout.legend.fontSize', { def: 16, min: 8, max: 48 }),
    COLOR('style.chart.layout.legend.color', { def: '#1A1A1A' }),
    NUMBER('style.chart.layout.legend.roundingValue', {
        def: 2,
        min: 0,
        max: 12,
    }),
    NUMBER('style.chart.layout.legend.roundingPercentage', {
        def: 2,
        min: 0,
        max: 12,
    }),
    ...
    TEXT('style.chart.layout.title.text', {
    ...
    TEXT('style.chart.layout.title.subtitle.text', {
        def: 'Lorem ipsum dolor sic amet',
    }),
    COLOR('style.chart.layout.title.subtitle.color', { def: '#CCCCCC' }),
    CHECKBOX('style.chart.layout.title.subtitle.bold', { def: false }),
    NUMBER('style.chart.layout.title.subtitle.fontSize', {
        def: 16,
        min: 8,
        max: 48,
    }),
    NUMBER('style.chart.layout.title.subtitle.offsetY', {
        def: 0,
        min: -100,
        max: 100,
    }),
        ...
        >
            ...
            <template #source>
                <div style="width: 100%; font-size: 10px; text-align: left">
                    SOURCE: Lorem ipsum dolor sit, amet consectetur adipisicing
                    elit. Tenetur, molestiae perspiciatis nam quae libero,
                    deserunt in aperiam unde officia sint saepe laboriosam
                    ducimus aspernatur labore! Sapiente aspernatur corrupti quis
                    ad.
                </div>
            </template>
        </LocalVueUiChestnut>
