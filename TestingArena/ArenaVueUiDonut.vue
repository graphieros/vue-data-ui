...
const model = createModel([
    ...
    NUMBER('serieToggleAnimation.durationMs', {
        def: 500,
        min: 0,
        max: 5000,
        step: 100,
    ...
    NUMBER('loadAnimation.durationMs', {
        def: 1000,
        min: 0,
        max: 5000,
        step: 500,
    ...
    CHECKBOX('userOptions.show', {
        def: true,
        label: 'showUserOptions',
        category: 'general',
    }),
    ...
    CHECKBOX('useCssAnimation', {
        def: false,
        label: 'useCssAnimation',
        category: 'general',
    }),
    CHECKBOX('useBlurOnHover', {
        def: true,
        label: 'useBlurOnHover',
        category: 'general',
    }),
    ...
    CHECKBOX('style.chart.useGradient', {
        def: false,
        label: 'useGradient',
        category: 'general',
    }),
    RANGE('style.chart.gradientIntensity', {
        def: 40,
        min: 0,
        max: 100,
        label: 'gradientIntensity',
        category: 'general',
    }),
    COLOR('style.chart.backgroundColor', {
        def: '#FFFFFF',
    ...
    CHECKBOX('style.chart.layout.labels.dataLabels.showValueFirst', {
        def: false,
    }),
    CHECKBOX('style.chart.layout.labels.dataLabels.usePercentageParens', {
        def: false,
    }),
    CHECKBOX('style.chart.layout.labels.dataLabels.useValueParens', {
        def: true,
    }),

    CHECKBOX('style.chart.layout.labels.dataLabels.show', {
        def: true,
        label: 'show',
        category: 'labels',
    }),
    CHECKBOX('style.chart.layout.labels.dataLabels.oneLine', { def: true }),
    NUMBER('style.chart.layout.labels.dataLabels.hideUnderValue', {
        def: 0,
        min: 0,
        max: 100,
        label: 'hideUnderValue',
        category: 'labels',
    }),
    NUMBER('style.chart.layout.labels.dataLabels.smallArcClusterThreshold', {
        def: 8,
        min: 0,
        max: 100,
    }),
    NUMBER('style.chart.layout.labels.dataLabels.smallArcClusterFontSize', {
        def: 12,
        min: 8,
        max: 48,
    }),
    CHECKBOX('style.chart.layout.labels.dataLabels.useLabelSlots', {
        def: false,
    }),
    TEXT('style.chart.layout.labels.dataLabels.prefix', {
        def: '',
        label: 'prefix',
        category: 'labels',
    }),
    TEXT('style.chart.layout.labels.dataLabels.suffix', {
        def: '',
        label: 'suffix',
        category: 'labels',
    }),

    CHECKBOX('style.chart.layout.labels.value.show', {
        def: true,
        label: 'showValue',
        category: 'labels',
    }),
    NUMBER('style.chart.layout.labels.value.rounding', {
        def: 0,
        min: 0,
        max: 6,
        label: 'valueRounding',
    ...
    COLOR('style.chart.layout.labels.percentage.color', {
        def: '#1A1A1A',
        label: 'colorPercentage',
        category: 'labels',
    }),
    CHECKBOX('style.chart.layout.labels.percentage.bold', {
        def: true,
        label: 'bold',
        category: 'labels',
    }),
    NUMBER('style.chart.layout.labels.percentage.fontSize', {
        def: 14,
        min: 6,
        max: 48,
        label: 'fontSize',
    ...
    NUMBER('style.chart.layout.labels.percentage.minFontSize', {
        def: 8,
        min: 6,
        max: 48,
        label: 'fontSize',
    ...
    CHECKBOX('style.chart.layout.labels.name.show', {
        def: true,
        label: 'bold',
        category: 'labels',
    }),
    COLOR('style.chart.layout.labels.name.color', {
        def: '#1A1A1A',
        label: 'colorName',
        category: 'labels',
    }),
    CHECKBOX('style.chart.layout.labels.name.bold', {
        def: false,
        label: 'bold',
        category: 'labels',
    }),
    NUMBER('style.chart.layout.labels.name.fontSize', {
        def: 14,
        min: 6,
        max: 36,
        label: 'fontSize',
    ...
    NUMBER('style.chart.layout.labels.name.minFontSize', {
        def: 8,
        min: 6,
        max: 36,
        label: 'fontSize',
    ...
    CHECKBOX('style.chart.layout.labels.hollow.show', {
        def: true,
        label: ['hollow', 'is', 'show'],
        category: 'labels',
    }),
    CHECKBOX('style.chart.layout.labels.hollow.total.show', {
        def: true,
        label: ['hollow', 'total', 'is', 'show'],
        category: 'labels',
    }),
    CHECKBOX('style.chart.layout.labels.hollow.total.bold', {
        def: false,
        label: ['hollow', 'total', 'is', 'bold'],
        category: 'labels',
    }),
    NUMBER('style.chart.layout.labels.hollow.total.fontSize', {
        def: 18,
        min: 6,
        max: 48,
        label: ['hollow', 'total', 'is', 'fontSize'],
        category: 'labels',
    }),
    COLOR('style.chart.layout.labels.hollow.total.color', {
        def: '#AAAAAA',
        label: ['hollow', 'total', 'is', 'color'],
        category: 'labels',
    }),
    TEXT('style.chart.layout.labels.hollow.total.text', {
        def: 'Total',
        label: ['hollow', 'total', 'is', 'textContent'],
        category: 'labels',
    }),
    NUMBER('style.chart.layout.labels.hollow.total.offsetY', {
        def: 0,
        min: -100,
        max: 100,
        label: ['hollow', 'total', 'is', 'offsetY'],
        category: 'labels',
    }),
    COLOR('style.chart.layout.labels.hollow.total.value.color', {
        def: '#1A1A1A',
        label: ['hollow', 'total', 'value', 'is', 'color'],
        category: 'labels',
    }),
    NUMBER('style.chart.layout.labels.hollow.total.value.fontSize', {
        def: 18,
        min: 6,
        max: 48,
        label: ['hollow', 'total', 'value', 'is', 'fontSize'],
        category: 'labels',
    }),
    CHECKBOX('style.chart.layout.labels.hollow.total.value.bold', {
        def: true,
        label: ['hollow', 'total', 'value', 'is', 'bold'],
        category: 'labels',
    }),
    TEXT('style.chart.layout.labels.hollow.total.value.prefix', {
        def: '',
        label: ['hollow', 'total', 'value', 'is', 'prefix'],
        category: 'labels',
    }),
    TEXT('style.chart.layout.labels.hollow.total.value.suffix', {
        def: '',
        label: ['hollow', 'total', 'value', 'is', 'suffix'],
        category: 'labels',
    }),
    NUMBER('style.chart.layout.labels.hollow.total.value.offsetY', {
        def: 0,
        min: -100,
        max: 100,
        label: ['hollow', 'total', 'value', 'is', 'offsetY'],
        category: 'labels',
    }),
    NUMBER('style.chart.layout.labels.hollow.total.value.rounding', {
        def: 0,
        min: 0,
        max: 6,
        label: ['hollow', 'total', 'value', 'is', 'rounding'],
        category: 'labels',
    }),
    CHECKBOX('style.chart.layout.labels.hollow.average.show', {
        def: true,
        label: ['hollow', 'average', 'is', 'show'],
        category: 'labels',
    }),
    CHECKBOX('style.chart.layout.labels.hollow.average.bold', {
        def: false,
        label: ['hollow', 'average', 'is', 'bold'],
        category: 'labels',
    }),
    COLOR('style.chart.layout.labels.hollow.average.color', {
        def: '#AAAAAA',
        label: ['hollow', 'average', 'is', 'color'],
        category: 'labels',
    }),
    NUMBER('style.chart.layout.labels.hollow.average.fontSize', {
        def: 18,
        min: 6,
        max: 48,
        label: ['hollow', 'average', 'is', 'fontSize'],
        category: 'labels',
    }),
    TEXT('style.chart.layout.labels.hollow.average.text', {
        def: 'Average',
        label: ['hollow', 'average', 'is', 'textContent'],
        category: 'labels',
    }),
    NUMBER('style.chart.layout.labels.hollow.average.offsetY', {
        def: 0,
        min: -100,
        max: 100,
        label: ['hollow', 'average', 'is', 'offsetY'],
        category: 'labels',
    }),
    COLOR('style.chart.layout.labels.hollow.average.value.color', {
        def: '#1A1A1A',
        label: ['hollow', 'average', 'value', 'is', 'color'],
        category: 'labels',
    }),
    NUMBER('style.chart.layout.labels.hollow.average.value.fontSize', {
        def: 18,
        min: 6,
        max: 48,
        label: ['hollow', 'average', 'value', 'is', 'fontSize'],
        category: 'labels',
    }),
    CHECKBOX('style.chart.layout.labels.hollow.average.value.bold', {
        def: true,
        label: ['hollow', 'average', 'value', 'is', 'bold'],
        category: 'labels',
    }),
    TEXT('style.chart.layout.labels.hollow.average.value.prefix', {
        def: '',
        label: ['hollow', 'average', 'value', 'is', 'prefix'],
        category: 'labels',
    }),
    TEXT('style.chart.layout.labels.hollow.average.value.suffix', {
        def: '',
        label: ['hollow', 'average', 'value', 'is', 'suffix'],
        category: 'labels',
    }),
    NUMBER('style.chart.layout.labels.hollow.average.value.offsetY', {
        def: 0,
        min: -100,
        max: 100,
        label: ['hollow', 'average', 'value', 'is', 'offsetY'],
        category: 'labels',
    }),
    NUMBER('style.chart.layout.labels.hollow.average.value.rounding', {
        def: 0,
        min: 0,
        max: 6,
        label: ['hollow', 'average', 'value', 'is', 'rounding'],
        category: 'labels',
    }),
    RANGE('style.chart.layout.donut.strokeWidth', {
        def: 64,
        min: 3,
        max: 130,
        label: 'thickness',
    ...
    RANGE('style.chart.layout.donut.borderWidth', {
        def: 1,
        min: 0,
        max: 36,
    ...
    NUMBER('style.chart.layout.donut.radiusRatio', {
        def: 0.3,
        min: 0.1,
        max: 0.5,
        step: 0.01,
    }),
    CHECKBOX('style.chart.legend.show', {
        def: true,
        label: 'show',
        category: 'legend',
    }),
    COLOR('style.chart.legend.backgroundColor', {
        def: '#FFFFFF20',
        label: 'backgroundColor',
        category: 'legend',
    }),
    COLOR('style.chart.legend.color', {
        def: '#1A1A1A',
        label: 'textColor',
        category: 'legend',
    }),
    NUMBER('style.chart.legend.fontSize', {
        def: 16,
        min: 6,
        max: 42,
        label: 'fontSize',
    ...
    CHECKBOX('style.chart.legend.bold', {
        def: false,
        label: 'bold',
        category: 'legend',
    }),
    NUMBER('style.chart.legend.roundingValue', {
        def: 0,
        min: 0,
        max: 6,
        label: ['rounding', 'is', 'value'],
        category: 'legend',
    }),
    NUMBER('style.chart.legend.roundingPercentage', {
        def: 0,
        min: 0,
        max: 6,
        label: 'percentageRounding',
        category: 'legend',
    }),
    ...
    NUMBER('table.responsiveBreakpoint', {
        def: 400,
        min: 300,
        max: 800,
    ...
    TEXT('table.columnNames.series', {
        def: 'Series',
        label: ['columnName', 'is', 'series'],
        category: 'table',
    }),
    TEXT('table.columnNames.value', {
        def: 'Value',
        label: ['columnName', 'is', 'value'],
        category: 'table',
    }),
    TEXT('table.columnNames.percentage', {
        def: 'Percentage',
        label: ['columnName', 'is', 'percentage'],
        category: 'table',
    }),
    COLOR('table.th.backgroundColor', {
        def: '#FFFFFF',
        label: 'backgroundColorHeader',
        category: 'table',
    }),
    COLOR('table.th.color', {
        def: '#1A1A1A',
        label: 'textColorHeader',
        category: 'table',
    }),
    TEXT('table.th.outline', {
        def: 'none',
        label: 'outlineHeader',
        category: 'table',
    }),
    COLOR('table.td.backgroundColor', {
        def: '#FFFFFF',
        label: 'backgroundColorRow',
        category: 'table',
    }),
    ...
    TEXT('table.td.outline', {
        def: 'none',
        label: 'outlineRow',
        category: 'table',
    }),
    NUMBER('table.td.roundingValue', {
        def: 0,
        min: 0,
        max: 6,
        label: ['rounding', 'is', 'value'],
    ...
    NUMBER('table.td.roundingPercentage', {
        def: 0,
        min: 0,
        max: 6,
        label: ['rounding', 'is', 'percentage'],
        category: 'table',
    }),
    ...
    CHECKBOX('style.chart.tooltip.show', {
        def: true,
        label: 'show',
        category: 'tooltip',
    }),
    COLOR('style.chart.tooltip.backgroundColor', {
        def: '#FFFFFF',
        label: 'backgroundColor',
        category: 'tooltip',
    }),
    COLOR('style.chart.tooltip.color', {
        def: '#1A1A1A',
        label: 'textColor',
        category: 'tooltip',
    }),
    NUMBER('style.chart.tooltip.fontSize', {
        def: 14,
        min: 6,
        max: 24,
        label: 'fontSize',
    ...
    CHECKBOX('style.chart.tooltip.showValue', {
        def: true,
        label: 'showValue',
        category: 'tooltip',
    }),
    NUMBER('style.chart.tooltip.roundingValue', {
        def: 0,
        min: 0,
        max: 6,
        label: ['rounding', 'is', 'value'],
    ...
    CHECKBOX('style.chart.tooltip.showPercentage', {
        def: true,
    ...
    <Box comp="VueUiDonut" :dataset="dataset" :config="config">
            ...
            >
                ...
                >
                    ...
                    <template #plot-comment="{ plot }">
                        <div
                            :style="`text-align:${plot.textAlign};font-size: 10px; padding: 6px;`"
                        >
                            {{ plot.comment }}
                        </div>
                    </template>
                    ...
                    <template #source>
                        ...
                        >
                            ...
                            elit. Tenetur, molestiae perspiciatis nam quae
                            libero, deserunt in aperiam unde officia sint saepe
        ...
        <template #local>
            ...
            >
                ...
                <template #optionCsv> DOWNLOAD CSV </template>
                <template #optionImg> DOWNLOAD IMAGE </template>
                <template #optionTable> TOGGLE TABLE </template>
                <template #optionLabels> TOGGLE LABELS </template>
                <template #optionSvg> DOWNLOAD SVG </template>
            ...
            >
                ...
                <template #source>
                    <div style="width: 100%; font-size: 10px; text-align: left">
                        Lorem ipsum dolor sit, amet consectetur adipisicing
                        elit. Tenetur, molestiae perspiciatis nam quae libero,
                        deserunt in aperiam unde officia sint saepe laboriosam
                        ducimus aspernatur labore! Sapiente aspernatur corrupti
                        quis ad.
                    </div>
                </template>
            </LocalVueDataUi>
        ...
        <template #build-treesh>
            <VueUiDonutTreeshaken :dataset="dataset" :config="config">
