...
const model = createModel([
    ...
    NUMBER('style.chart.layout.grid.strokeWidth', {
        def: 0.7,
        min: 0.5,
        max: 12,
        step: 0.1,
    ...
    NUMBER('style.chart.layout.grid.yAxis.dataLabels.fontSize', {
        def: 10,
        min: 8,
        max: 24,
    }),
    COLOR('style.chart.layout.grid.yAxis.dataLabels.color', { def: '#1A1A1A' }),
    NUMBER('style.chart.layout.grid.yAxis.dataLabels.roundingValue', {
        def: 2,
        min: 0,
        max: 12,
    }),
    NUMBER('style.chart.layout.grid.yAxis.dataLabels.offsetX', {
        def: 0,
        min: -100,
        max: 100,
    }),
    CHECKBOX('style.chart.layout.grid.yAxis.dataLabels.bold', { def: false }),
    NUMBER('style.chart.layout.grid.yAxis.dataLabels.steps', {
        def: 10,
        min: 2,
        max: 20,
    }),
    ...
    NUMBER('style.chart.layout.grid.xAxis.dataLabels.fontSize', {
        def: 8,
        min: 8,
        max: 24,
    }),
    CHECKBOX('style.chart.layout.grid.xAxis.dataLabels.showOnlyFirstAndLast', {
        def: false,
    }),
    COLOR('style.chart.layout.grid.xAxis.dataLabels.color', { def: '#1A1A1A' }),
    NUMBER('style.chart.layout.grid.xAxis.dataLabels.rotation', {
        def: 0,
        min: -360,
        max: 360,
    }),
    NUMBER('style.chart.layout.grid.xAxis.dataLabels.autoRotate.angle', {
        def: -90,
        min: -90,
        max: 90,
    }),
    NUMBER('style.chart.layout.grid.xAxis.dataLabels.offsetY', {
        def: 0,
        min: -100,
        max: 100,
    }),
    ...
    NUMBER('style.chart.layout.grid.axis.yLabelOffsetX', {
        def: 0,
        min: 0,
        max: 100,
    }),
    NUMBER('style.chart.layout.grid.axis.xLabelOffsetY', {
        def: 0,
        min: 0,
        max: 100,
    }),
    NUMBER('style.chart.layout.grid.axis.fontSize', {
        def: 14,
        min: 8,
        max: 42,
    }),
    ...
    NUMBER('style.chart.layout.dataLabels.fontSize', {
        def: 10,
        min: 8,
        max: 48,
    }),
    ...
    NUMBER('style.chart.layout.dataLabels.rounding', {
        def: 2,
        min: 0,
        max: 12,
    }),
    ...
    NUMBER('style.chart.layout.dataLabels.offsetY', {
        def: 0,
        min: -100,
        max: 100,
    }),
