...
const model = createModel([
    ...
    SELECT('style.chart.plots.link.type', ['curved', 'line'], {
        def: 'curved',
    }),
    CHECKBOX('style.chart.plots.gradient.show', { def: true }),
    RANGE('style.chart.plots.gradient.intensity', {
        def: 40,
        min: 0,
        max: 100,
    }),
    ...
    NUMBER('style.chart.grid.horizontalGrid.strokeWidth', {
        def: 0.5,
        min: 0,
        max: 12,
        step: 0.5,
    }),
    NUMBER('style.chart.grid.horizontalGrid.strokeDasharray', {
        def: 4,
        min: 0,
        max: 100,
    }),
    ...
    NUMBER('style.chart.grid.verticalGrid.strokeWidth', {
        def: 0.5,
        min: 0,
        max: 12,
        step: 0.5,
    }),
    NUMBER('style.chart.grid.verticalGrid.strokeDasharray', {
        def: 0,
        min: 0,
        max: 100,
    }),
    ...
    NUMBER('style.chart.labels.axis.yLabelOffsetX', {
        def: 0,
        min: -100,
        max: 100,
    }),
    NUMBER('style.chart.labels.axis.xLabelOffsetY', {
        def: 0,
        min: -100,
        max: 100,
    }),
    ...
    NUMBER('style.chart.labels.yAxisLabels.fontSize', {
        def: 14,
        min: 8,
        max: 48,
    }),
    COLOR('style.chart.labels.yAxisLabels.color', { def: '#1A1A1A' }),
    NUMBER('style.chart.labels.yAxisLabels.offsetX', {
        def: 0,
        min: -100,
        max: 100,
    }),
    ...
    NUMBER('style.chart.labels.yAxisLabels.rounding', {
        def: 1,
        min: 0,
        max: 12,
    }),
    ...
    NUMBER('style.chart.labels.xAxisLabels.fontSize', {
        def: 14,
        min: 8,
        max: 48,
    }),
    COLOR('style.chart.labels.xAxisLabels.color', { def: '#1A1A1A' }),
    NUMBER('style.chart.labels.xAxisLabels.offsetY', {
        def: 0,
        min: -100,
        max: 100,
    }),
    CHECKBOX('style.chart.labels.xAxisLabels.bold', { def: false }),
    NUMBER('style.chart.labels.xAxisLabels.rounding', {
        def: 2,
        min: 0,
        max: 12,
    }),
    NUMBER('style.chart.labels.xAxisLabels.autoRotate.angle', {
        def: -90,
        min: -90,
        max: 90,
    }),
    ...
    NUMBER('style.chart.labels.startLabels.fontSize', {
        def: 10,
        min: 8,
        max: 24,
    }),
    COLOR('style.chart.labels.startLabels.color', { def: '#1A1A1A' }),
    NUMBER('style.chart.labels.startLabels.offsetY', {
        def: 0,
        min: -100,
        max: 100,
    }),
    NUMBER('style.chart.labels.startLabels.rounding', {
        def: 2,
        min: 0,
        max: 12,
    }),
    CHECKBOX('style.chart.labels.startLabels.useStartColor', { def: true }),
    CHECKBOX('style.chart.labels.startLabels.useEvaluationColor', {
        def: true,
    }),

    CHECKBOX('style.chart.labels.endLabels.show', { def: true }),
    NUMBER('style.chart.labels.endLabels.fontSize', {
        def: 10,
        min: 8,
        max: 24,
    }),
    COLOR('style.chart.labels.endLabels.color', { def: '#1A1A1A' }),
    NUMBER('style.chart.labels.endLabels.offsetY', {
        def: 0,
        min: -100,
        max: 100,
    }),
    NUMBER('style.chart.labels.endLabels.rounding', {
        def: 2,
        min: 0,
        max: 12,
    }),
...
<template>
    ...
    <Box comp="VueUiDumbbell" :dataset="dataset" :config="config">
