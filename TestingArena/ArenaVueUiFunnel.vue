...
const model = createModel([
    ...
    RANGE('style.chart.barCircleSpacingRatio', {
        def: 0.05,
        min: 0,
        max: 0.5,
        step: 0.01,
    ...
    RANGE('style.chart.circles.dataLabels.fontSize', {
        def: 16,
        min: 8,
        max: 48,
    }),
    NUMBER('style.chart.circles.dataLabels.offsetY', {
        def: 0,
        min: -100,
        max: 100,
    }),
    CHECKBOX('style.chart.circles.dataLabels.adaptColorToBackground', {
        def: true,
    }),
    COLOR('style.chart.circles.dataLabels.color', { def: '#1A1A1A' }),
    NUMBER('style.chart.circles.dataLabels.rounding', {
        def: 1,
        min: 0,
        max: 6,
    }),
    ...
    RANGE('style.chart.circleLinks.widthRatio', {
        def: 1,
        min: 0.1,
        max: 2,
        step: 0.01,
    ...
    RANGE('style.chart.bars.gapRatio', {
        def: 0.2,
        min: 0,
        max: 1,
        step: 0.01,
    ...
    NUMBER('style.chart.bars.dataLabels.name.fontSize', {
        def: 16,
        min: 8,
        max: 42,
    }),
    ...
    NUMBER('style.chart.bars.dataLabels.name.offsetX', {
        def: 0,
        min: -100,
        max: 100,
    }),
    NUMBER('style.chart.bars.dataLabels.name.offsetY', {
        def: 0,
        min: -100,
        max: 100,
    }),

    NUMBER('style.chart.bars.dataLabels.value.fontSize', {
        def: 16,
        min: 8,
        max: 42,
    }),
    NUMBER('style.chart.bars.dataLabels.value.rounding', {
        def: 0,
        min: 0,
        max: 6,
    }),
    ...
    NUMBER('style.chart.bars.dataLabels.value.offsetX', {
        def: 0,
        min: -100,
        max: 100,
    }),
    NUMBER('style.chart.bars.dataLabels.value.offsetY', {
        def: 0,
        min: -100,
        max: 100,
    }),
