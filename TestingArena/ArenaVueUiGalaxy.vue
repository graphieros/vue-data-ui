...
const model = createModel([
    ...
    NUMBER('style.chart.layout.arcs.hoverEffect.multiplicator', {
        def: 1.1,
        min: 1,
        max: 2,
        step: 0.05,
    ...
    RANGE('style.chart.layout.arcs.gradient.intensity', {
        def: 30,
        min: 0,
        max: 100,
    }),
...
<template>
    ...
    <Box comp="VueUiGalaxy" :dataset="dataset" :config="config">
