...
const model = createModel([
    ...
    RANGE('style.chart.layout.radiusRatio', {
        def: 0.8,
        min: 0.5,
        max: 1.2,
        step: 0.01,
    }),
    RANGE('style.chart.layout.track.size', {
        def: 1,
        min: 0.5,
        max: 2,
        step: 0.01,
    ...
    RANGE('style.chart.layout.track.gradientIntensity', {
        def: 20,
        min: 10,
        max: 30,
    }),
    ...
    RANGE('style.chart.layout.markers.fontSizeRatio', {
        def: 1,
        min: 0,
        max: 2,
        step: 0.01,
    }),
    NUMBER('style.chart.layout.markers.offsetY', {
        def: 0,
        min: -100,
        max: 100,
    }),
    NUMBER('style.chart.layout.markers.roundingValue', {
        def: 0,
        min: 0,
        max: 12,
    }),
    ...
    SELECT('style.chart.layout.pointer.type', ['rounded', 'pointy'], {
        def: 'pointy',
    }),
    RANGE('style.chart.layout.pointer.size', {
        def: 1,
        min: 0.2,
        max: 1.5,
        step: 0.01,
    ...
    RANGE('style.chart.layout.pointer.strokeWidth', {
        def: 12,
        min: 1,
        max: 48,
        step: 0.5,
    ...
    RANGE('style.chart.layout.pointer.circle.radius', {
        def: 3,
        min: 0,
        max: 48,
        step: 0.5,
    ...
    RANGE('style.chart.layout.pointer.circle.strokeWidth', {
        def: 2,
        min: 0,
        max: 12,
        step: 0.5,
    ...
    TEXT('style.chart.title.subtitle.text', {
        def: 'Lorem ipsum dolor sic amet',
    }),
    ...
    RANGE('style.chart.layout.segmentNames.offsetRatio', {
        def: 1.1,
        min: 0.5,
        max: 1.3,
        step: 0.01,
    }),
    NUMBER('style.chart.layout.segmentNames.fontSize', {
        def: 16,
        min: 8,
        max: 42,
    }),
    ...
    CHECKBOX('style.chart.layout.segmentNames.markers.useSerieColor', {
        def: true,
    }),
    ...
    NUMBER('style.chart.layout.segmentSeparators.offsetOut', {
        def: 0,
        min: 0,
        max: 100,
    }),
    NUMBER('style.chart.layout.segmentSeparators.offsetIn', {
        def: 0,
        min: 0,
        max: 100,
    }),
    COLOR('style.chart.layout.segmentSeparators.stroke', { def: '#1A1A1A' }),
    NUMBER('style.chart.layout.segmentSeparators.strokeWidth', {
        def: 2,
        min: 0,
        max: 12,
    }),
    ...
    NUMBER('style.chart.layout.indicatorArc.radius', {
        def: 123,
        min: 0,
        max: 200,
    }),
                    ...
                    <template #pattern="{ seriesIndex, patternId }">
                        ...
                        <pattern
                            ...
                            ><rect
                                ...
                                fill="#2b2b3100" /><path
                                fill="#ecc94b"
                                d="M20 8.52h20v2.96H20zM20 20h20v20H20z" /><path
                                fill="#f44034"
