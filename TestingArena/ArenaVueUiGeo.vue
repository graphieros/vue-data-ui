...
const model = createModel([
    ...
    NUMBER('style.chart.territory.hover.strokeWidth', {
        def: 1.5,
        min: 0,
        max: 6,
    }),

    NUMBER('style.chart.points.radius', {
        def: 1,
        min: 0.1,
        max: 5,
        step: 0.1,
    ...
    NUMBER('style.chart.points.hoverRadiusRatio', {
        def: 1.2,
        min: 1,
        max: 1.5,
        step: 0.1,
    ...
    NUMBER('style.chart.points.labels.fontSizeRatio', {
        def: 1.2,
        min: 0.5,
        max: 2,
        step: 0.1,
