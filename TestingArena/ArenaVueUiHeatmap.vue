...
const model = createModel([
    ...
    NUMBER('style.layout.crosshairs.strokeDasharray', {
        def: 0,
        min: 0,
        max: 12,
    }),
    ...
    NUMBER('style.layout.cells.value.roundingValue', {
        def: 2,
        min: 0,
        max: 12,
    }),
    ...
    RANGE('style.layout.cells.columnTotal.value.rotation', {
        def: 0,
        min: -90,
        max: 90,
    }),
    NUMBER('style.layout.cells.columnTotal.value.autoRotate.angle', {
        def: -90,
        min: -90,
        max: 90,
    }),
    NUMBER('style.layout.cells.columnTotal.value.offsetX', {
        def: 0,
        min: -30,
        max: 30,
    }),
    NUMBER('style.layout.cells.columnTotal.value.offsetY', {
        def: 0,
        min: -30,
        max: 30,
    }),
    ...
    NUMBER('style.layout.dataLabels.xAxis.showOnlyAtModulo', {
        def: null,
        min: 2,
        max: 24,
    }),
    NUMBER('style.layout.dataLabels.xAxis.rotation', {
        def: 0,
        min: -90,
        max: 0,
    }),
                ...
                layout: {
                    ...
                    dataLabels: {
                        ...
                        xAxis: {
                            ...
                            values: [
                                1754604000000, 1754690400000, 1754776800000,
                                1754863200000, 1754949600000, 1755036000000,
                                1755122400000, 1755208800000, 1755295200000,
                                1755381600000, 1755468000000, 1755554400000,
                                1755640800000, 1755727200000, 1755813600000,
                                1755900000000, 1755986400000, 1756072800000,
                                1756159200000, 1756245600000, 1756332000000,
                                1756418400000, 1756504800000, 1756591200000,
                                1756677600000, 1756764000000,
                            ],
                            datetimeFormatter: {
                                enable: true,
                                locale: 'zh-CN',
