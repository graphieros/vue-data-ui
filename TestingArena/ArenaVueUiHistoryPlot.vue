...
const model = createModel([
    ...
    NUMBER('style.chart.grid.horizontalLines.strokeWidth', {
        def: 0.6,
        min: 0,
        max: 12,
        step: 0.1,
    ...
    NUMBER('style.chart.grid.verticalLines.strokeWidth', {
        def: 0.6,
        min: 0,
        max: 12,
        step: 0.1,
    ...
    NUMBER('style.chart.axes.x.labels.autoRotate.angle', {
        def: -90,
        min: -90,
        max: 90,
    }),
    ...
    CHECKBOX('style.chart.plots.indexLabels.adaptColorToBackground', {
        def: true,
    }),
    COLOR('style.chart.plots.indexLabels.color', { def: '#1A1A1A' }),
    NUMBER('style.chart.plots.indexLabels.fontSize', {
        def: 16,
        min: 8,
        max: 42,
    }),
    CHECKBOX('style.chart.plots.indexLabels.bold', { def: false }),
    NUMBER('style.chart.plots.indexLabels.offsetY', {
        def: 0,
        min: -100,
        max: 100,
    }),
    NUMBER('style.chart.plots.indexLabels.offsetX', {
        def: 0,
        min: -100,
        max: 100,
    }),
    ...
    NUMBER('style.chart.paths.strokeWidth', {
        def: 1.6,
        min: 0,
        max: 12,
        step: 0.1,
