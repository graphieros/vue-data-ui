...
const { local, build, vduiLocal, vduiBuild, toggleTable, toggleSort } =
    useArena();
...
const model = createModel([
    ...
    SELECT('style.chart.layout.bars.sort', ['asc', 'desc', 'none'], {
        def: 'desc',
    }),
    ...
    NUMBER('style.chart.layout.bars.paddingRight', {
        def: 0,
        min: 0,
        max: 100,
    }),
    CHECKBOX('style.chart.layout.bars.useGradient', { def: true }),
    RANGE('style.chart.layout.bars.gradientIntensity', {
        def: 20,
        min: 0,
        max: 100,
    }),
    ...
    RANGE('style.chart.layout.bars.dataLabels.fontSize', {
        def: 14,
        min: 8,
        max: 48,
    }),
    CHECKBOX('style.chart.layout.bars.dataLabels.value.show', { def: true }),
    NUMBER('style.chart.layout.bars.dataLabels.value.roundingValue', {
        def: 2,
        min: 0,
        max: 12,
    }),
    ...
    CHECKBOX('style.chart.layout.bars.dataLabels.percentage.show', {
        def: true,
    }),
    NUMBER('style.chart.layout.bars.dataLabels.percentage.roundingPercentage', {
        def: 2,
        min: 0,
        max: 12,
    }),
    NUMBER('style.chart.layout.bars.dataLabels.offsetX', {
        def: 12,
        min: -100,
        max: 100,
    }),
    ...
    RANGE('style.chart.layout.bars.nameLabels.fontSize', {
        def: 14,
        min: 8,
        max: 48,
    }),
    NUMBER('style.chart.layout.bars.nameLabels.offsetX', {
        def: 0,
        min: -100,
        max: 100,
    }),
    ...
    RANGE('style.chart.layout.bars.parentLabels.fontSize', {
        def: 14,
        min: 8,
        max: 48,
    }),
    NUMBER('style.chart.layout.bars.parentLabels.offsetX', {
        def: 0,
        min: -100,
        max: 100,
    }),
    COLOR('style.chart.layout.highlighter.color', { def: '#1A1A1A' }),
    RANGE('style.chart.layout.highlighter.opacity', {
        def: 5,
        min: 0,
        max: 100,
    }),
    ...
    NUMBER('style.chart.layout.separators.strokeWidth', {
        def: 1,
        min: 0,
        max: 12,
    }),
    ...
    <Box comp="VueUiVerticalBar" :dataset="dataset" :config="config">
        ...
        <template #local>
            ...
            >
                ...
                <template #optionSort> SORT </template>
                <template #svg="{ svg }">
