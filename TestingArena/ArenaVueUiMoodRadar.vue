...
const model = createModel([
    ...
    NUMBER('style.chart.layout.outerPolygon.strokeWidth', {
        def: 1,
        min: 0,
        max: 12,
    }),
    ...
    RANGE('style.chart.layout.dataPolygon.opacity', {
        def: 60,
        min: 0,
        max: 100,
    }),
    CHECKBOX('style.chart.layout.dataPolygon.gradient.show', { def: true }),
    RANGE('style.chart.layout.dataPolygon.gradient.intensity', {
        def: 5,
        min: 0,
        max: 100,
    }),
    COLOR('style.chart.layout.dataPolygon.stroke', { def: '#1A1A1A' }),
    NUMBER('style.chart.layout.dataPolygon.strokeWidth', {
        def: 1,
        min: 0,
        max: 12,
    }),

    NUMBER('style.chart.layout.smileys.strokeWidth', {
        def: 1,
        min: 0,
        max: 12,
    }),
    ...
    NUMBER('style.chart.layout.dataLabel.roundingPercentage', {
        def: 2,
        min: 0,
        max: 12,
    }),
    NUMBER('style.chart.layout.dataLabel.roundingValue', {
        def: 2,
        min: 0,
        max: 12,
    }),
