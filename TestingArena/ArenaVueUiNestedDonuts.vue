...
const model = createModel([
    ...
    NUMBER('style.chart.layout.labels.dataLabels.fontSize', {
        def: 14,
        min: 8,
        max: 48,
    }),
    NUMBER('style.chart.layout.labels.dataLabels.offsetX', {
        def: 4,
        min: -100,
        max: 100,
    }),
    NUMBER('style.chart.layout.labels.dataLabels.offsetY', {
        def: 12,
        min: -100,
        max: 100,
    }),
    CHECKBOX('style.chart.layout.labels.dataLabels.useSerieColor', {
        def: false,
    }),
    ...
    CHECKBOX('style.chart.layout.labels.dataLabels.showPercentage', {
        def: true,
    }),
    CHECKBOX('style.chart.layout.labels.dataLabels.boldValue', { def: false }),
    CHECKBOX('style.chart.layout.labels.dataLabels.boldPercentage', {
        def: true,
    }),
    NUMBER('style.chart.layout.labels.dataLabels.roundingValue', {
        def: 2,
        min: 0,
        max: 12,
    }),
    NUMBER('style.chart.layout.labels.dataLabels.roundingPercentage', {
        def: 2,
        min: 0,
        max: 12,
    }),
    CHECKBOX('style.chart.layout.labels.dataLabels.showDonutName', {
        def: true,
    }),
    CHECKBOX('style.chart.layout.labels.dataLabels.boldDonutName', {
        def: true,
    }),
    CHECKBOX('style.chart.layout.labels.dataLabels.donutNameAbbreviation', {
        def: false,
    }),
    CHECKBOX('style.chart.layout.labels.dataLabels.curvedDonutName', {
        def: true,
    }),
    NUMBER(
        'style.chart.layout.labels.dataLabels.donutNameMaxAbbreviationSize',
        {
            def: 3,
            min: 1,
            max: 12,
    ...
    NUMBER('style.chart.layout.labels.dataLabels.donutNameOffsetY', {
        def: -6,
        min: -100,
        max: 100,
    }),

    NUMBER('style.chart.layout.donut.strokeWidth', {
        def: 200,
        min: 50,
        max: 400,
    }),
    ...
    NUMBER('style.chart.layout.donut.spacingRatio', {
        def: 0.5,
        min: 0,
        max: 1,
        step: 0.01,
    ...
    COLOR('style.chart.legend.selectAllToggle.backgroundColor', {
        def: '#FF0000',
    }),
