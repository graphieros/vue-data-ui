...
const model = createModel([
    ...
    RANGE('style.chart.layout.gutter.width', {
        def: 0.62,
        min: 0.1,
        max: 1,
        step: 0.01,
    }),
    RANGE('style.chart.layout.track.width', {
        def: 0.62,
        min: 0.1,
        max: 1,
        step: 0.01,
    ...
    NUMBER('style.chart.layout.labels.roundingValue', {
        def: 2,
        min: 0,
        max: 12,
    }),
    NUMBER('style.chart.layout.labels.roundingPercentage', {
        def: 2,
        min: 0,
        max: 12,
    }),
    CHECKBOX('style.chart.layout.labels.bold', { def: true }),
    NUMBER('style.chart.layout.labels.offsetY', {
        def: 0,
        min: -100,
        max: 100,
    }),
    NUMBER('style.chart.layout.labels.offsetX', {
        def: 0,
        min: -100,
        max: 100,
    }),
...
<template>
    ...
    <Box comp="VueUiOnion" :dataset="dataset" :config="config">
