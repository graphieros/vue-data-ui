...
const model = createModel([
    ...
    NUMBER('style.chart.lines.opacity', {
        def: 0.8,
        min: 0,
        max: 1,
        step: 0.01,
    ...
    NUMBER('style.chart.yAxis.labels.ticks.fontSize', {
        def: 14,
        min: 8,
        max: 42,
    }),
    ...
    NUMBER('style.chart.yAxis.labels.ticks.offsetX', {
        def: 0,
        min: -100,
        max: 100,
    }),
    NUMBER('style.chart.yAxis.labels.ticks.offsetY', {
        def: 0,
        min: -100,
        max: 100,
    }),
    ...
    NUMBER('style.chart.yAxis.labels.datapoints.fontSize', {
        def: 14,
        min: 8,
        max: 42,
    }),
    CHECKBOX('style.chart.yAxis.labels.datapoints.useSerieColor', {
        def: true,
    }),
    COLOR('style.chart.yAxis.labels.datapoints.color', { def: '#1A1A1A' }),
    NUMBER('style.chart.yAxis.labels.datapoints.offsetX', {
        def: 0,
        min: -100,
        max: 100,
    }),
    NUMBER('style.chart.yAxis.labels.datapoints.offsetY', {
        def: 0,
        min: -100,
        max: 100,
    }),
    ...
    NUMBER('style.chart.yAxis.labels.axisNamesFontSize', {
        def: 16,
        min: 8,
        max: 42,
    }),
    CHECKBOX('style.chart.yAxis.labels.axisNamesBold', { def: true }),
    NUMBER('style.chart.yAxis.labels.axisNamesAutoRotate.angle', {
        def: -90,
        min: -90,
        max: 90,
    }),
...
<template>
    ...
    <Box comp="VueUiParallelCoordinatePlot" :dataset="dataset" :config="config">
            ...
            >
                ...
                >
                    ...
                    <template #plot-comment="{ plot }">
                        <div
                            :style="`width: 100%; text-align:center; color:${plot.color}`"
                        >
                            {{ plot.comment }}
                        </div>
                    </template>
        ...
        <template #build-treesh>
            <VueUiParallelCoordinatePlotTreeshaken
                @selectDatapoint="selectDatapoint"
                @selectLegend="selectLegend"
                :dataset="dataset"
                :config="config"
