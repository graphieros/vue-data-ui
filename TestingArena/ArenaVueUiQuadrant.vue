...
const { local, build, vduiLocal, vduiBuild, toggleTable, toggleLabels } =
    useArena();
...
const model = createModel([
    ...
    TEXT('style.chart.layout.labels.quadrantLabels.tl.text', {
        def: 'Top left label',
    }),
    COLOR('style.chart.layout.labels.quadrantLabels.tl.color', {
        def: '#FFAA00',
    }),
    RANGE('style.chart.layout.labels.quadrantLabels.tl.fontSize', {
        def: 16,
        min: 8,
        max: 42,
    }),
    ...
    TEXT('style.chart.layout.labels.quadrantLabels.tr.text', {
        def: 'Top right label',
    }),
    COLOR('style.chart.layout.labels.quadrantLabels.tr.color', {
        def: '#00BB63',
    }),
    RANGE('style.chart.layout.labels.quadrantLabels.tr.fontSize', {
        def: 16,
        min: 8,
        max: 42,
    }),
    ...
    TEXT('style.chart.layout.labels.quadrantLabels.br.text', {
        def: 'Bottom right label',
    }),
    COLOR('style.chart.layout.labels.quadrantLabels.br.color', {
        def: '#0063BB',
    }),
    RANGE('style.chart.layout.labels.quadrantLabels.br.fontSize', {
        def: 16,
        min: 8,
        max: 42,
    }),
    ...
    TEXT('style.chart.layout.labels.quadrantLabels.bl.text', {
        def: 'Bottom right label',
    }),
    COLOR('style.chart.layout.labels.quadrantLabels.bl.color', {
        def: '#BB0063',
    }),
    RANGE('style.chart.layout.labels.quadrantLabels.bl.fontSize', {
        def: 16,
        min: 8,
        max: 42,
    }),
    ...
    NUMBER('style.chart.layout.labels.plotLabels.offsetY', {
        def: 12,
        min: -100,
        max: 100,
    }),
    RANGE('style.chart.layout.labels.plotLabels.fontSize', {
        def: 10,
        min: 8,
        max: 48,
    }),
    ...
    RANGE('style.chart.layout.labels.axisLabels.fontSize', {
        def: 14,
        min: 8,
        max: 48,
    }),
    COLOR('style.chart.layout.labels.axisLabels.color.positive', {
        def: '#0000FF',
    }),
    COLOR('style.chart.layout.labels.axisLabels.color.negative', {
        def: '#FF0000',
    }),
    ...
    RANGE('style.chart.layout.grid.graduations.strokeWidth', {
        def: 0.5,
        min: 0,
        max: 64,
        step: 0.5,
    ...
    NUMBER('style.chart.layout.grid.graduations.steps', {
        def: 5,
        min: 2,
        max: 20,
    }),
    ...
    RANGE('style.chart.layout.grid.graduations.roundingForce', {
        def: 10,
        min: 0,
        max: 300,
    }),

    NUMBER('style.chart.layout.grid.xAxis.min', {
        def: -100,
        min: -1000,
        max: 1000,
    }),
    NUMBER('style.chart.layout.grid.xAxis.max', {
        def: 100,
        min: -1000,
        max: 1000,
    }),
    CHECKBOX('style.chart.layout.grid.xAxis.auto', { def: true }),
    CHECKBOX('style.chart.layout.grid.xAxis.name', {
        def: 'X axis lorem ipsum dolor sic amet',
    }),

    NUMBER('style.chart.layout.grid.yAxis.min', {
        def: -100,
        min: -1000,
        max: 1000,
    }),
    NUMBER('style.chart.layout.grid.yAxis.max', {
        def: 100,
        min: -1000,
        max: 1000,
    }),
    CHECKBOX('style.chart.layout.grid.yAxis.auto', { def: true }),
    CHECKBOX('style.chart.layout.grid.yAxis.name', {
        def: 'Y axis lorem ipsum dolor sic amet',
    }),
    ...
    RANGE('style.chart.layout.plots.outlineWidth', {
        def: 1,
        min: 0,
        max: 12,
        step: 0.5,
