                ...
                datapoints: [
                    {
                        name: 'Average Monthly Temperature (°C)',
                        values: [
                            11, 12, 13, 13, 14, 15, 15, 16, 17, 16, 14, 12,
                        ],
                    },
                ],
            }, // Mean ≈ 14°C
                ...
                datapoints: [
                    {
                        name: 'Average Monthly Temperature (°C)',
                        values: [
                            14, 15, 15, 17, 18, 20, 22, 22, 22, 19, 16, 13,
                        ],
                    },
                ],
            }, // Mean ≈ 18°C
                ...
                datapoints: [
                    {
                        name: 'Average Monthly Temperature (°C)',
                        values: [
                            13, 14, 15, 16, 16, 16, 15, 15, 15, 14, 13, 13,
                        ],
                    },
                ],
            }, // Mean ≈ 15°C
...
const model = createModel([
    ...
    NUMBER('style.chart.areas.height', {
        def: 60,
        min: 30,
        max: 100,
        step: 10,
    }),
    NUMBER('style.chart.areas.rowHeight', {
        def: 30,
        min: 10,
        max: 100,
        step: 10,
    ...
    NUMBER('style.chart.areas.opacity', {
        def: 0.9,
        min: 0.1,
        max: 1,
        step: 0.01,
    ...
    CHECKBOX('style.chart.areas.maxPoint.adaptStrokeToBackground', {
        def: true,
    }),
    COLOR('style.chart.areas.maxPoint.stroke', { def: '#1A1A1A' }),
    NUMBER('style.chart.areas.maxPoint.strokeWidth', {
        def: 1,
        min: 0,
        max: 12,
        step: 0.1,
    }),
    NUMBER('style.chart.areas.maxPoint.strokeDasharray', {
        def: 4,
        min: 0,
        max: 12,
    }),
    ...
    NUMBER('style.chart.selector.dot.strokeWidth', {
        def: 0.5,
        min: 0,
        max: 12,
        step: 0.1,
