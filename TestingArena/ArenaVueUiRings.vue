...
const model = createModel([
    ...
    RANGE('style.chart.layout.rings.gradient.intensity', {
        def: 40,
        min: 0,
        max: 100,
    }),
    COLOR('style.chart.layout.rings.gradient.underlayerColor', {
        def: '#FFFFFF',
    }),
    CHECKBOX('style.chart.layout.rings.useShadow', { def: true }),
