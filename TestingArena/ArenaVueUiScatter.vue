...
const model = createModel([
    ...
    NUMBER('style.layout.marginalBars.strokeWidth', {
        def: 1,
        min: 0,
        max: 12,
    }),
    NUMBER('style.layout.marginalBars.offset', { def: 20, min: 0, max: 100 }),
    NUMBER('style.layout.marginalBars.borderRadius', {
        def: 2,
        min: 0,
        max: 24,
    }),
    ...
    NUMBER('style.layout.marginalBars.linesStrokeWidth', {
        def: 1,
        min: 0.5,
        max: 12,
        step: 0.5,
    ...
    RANGE('style.layout.marginalBars.highlighter.opacity', {
        def: 0.1,
        min: 0,
        max: 1,
        step: 0.01,
    ...
    NUMBER('style.layout.marginalBars.highlighter.strokeWidth', {
        def: 0.5,
        min: 0,
        max: 12,
        step: 0.1,
    }),
    NUMBER('style.layout.marginalBars.highlighter.strokeDasharray', {
        def: 2,
        min: 0,
        max: 12,
    }),
    CHECKBOX('style.layout.marginalBars.highlighter.highlightBothAxes', {
        def: false,
    }),
    ...
    NUMBER('style.layout.plots.significance.opacity', {
        def: 0.3,
        min: 0,
        max: 1,
        step: 0.01,
    ...
    NUMBER('style.layout.plots.deviation.roundingValue', {
        def: 1,
        min: 0,
        max: 12,
    }),
    ...
    NUMBER('style.layout.plots.giftWrap.strokeWidth', {
        def: 1,
        min: 0,
        max: 12,
    }),
    NUMBER('style.layout.plots.giftWrap.strokeDasharray', {
        def: 0,
        min: 0,
        max: 100,
    }),
    NUMBER('style.layout.plots.giftWrap.fillOpacity', {
        def: 0.2,
        min: 0,
        max: 1,
        step: 0.01,
    ...
    NUMBER('style.layout.plots.selectors.strokeWidth', {
        def: 0.7,
        min: 0,
        max: 12,
        step: 0.1,
    }),
    NUMBER('style.layout.plots.selectors.strokeDasharray', {
        def: 0,
        min: 0,
        max: 100,
    }),
    NUMBER('style.layout.plots.selectors.labels.fontSize', {
        def: 12,
        min: 8,
        max: 24,
    }),
    COLOR('style.layout.plots.selectors.labels.color', { def: '#1A1A1A' }),
    NUMBER('style.layout.plots.selectors.labels.rounding', {
        def: 2,
        min: 0,
        max: 12,
    }),
    ...
    NUMBER('style.layout.plots.selectors.markers.radius', {
        def: 1.5,
        min: 0,
        max: 12,
        step: 0.5,
    ...
    NUMBER('style.layout.plots.selectors.markers.strokeWidth', {
        def: 0.5,
        min: 0,
        max: 12,
        step: 0.5,
    ...
    NUMBER('style.layout.correlation.strokeDasharray', {
        def: 2,
        min: 0,
        max: 100,
    }),
    ...
    NUMBER('style.layout.correlation.label.fontSize', {
        def: 12,
        min: 8,
        max: 48,
    }),
    ...
    NUMBER('style.layout.correlation.label.roundingValue', {
        def: 2,
        min: 0,
        max: 12,
    }),
    ...
    NUMBER('style.layout.dataLabels.xAxis.fontSize', {
        def: 8,
        min: 8,
        max: 24,
    }),
    ...
    NUMBER('style.layout.dataLabels.xAxis.offsetX', {
        def: 0,
        min: -100,
        max: 100,
    }),
    NUMBER('style.layout.dataLabels.xAxis.offsetY', {
        def: 0,
        min: -100,
        max: 100,
    }),
    NUMBER('style.layout.dataLabels.xAxis.roundingValue', {
        def: 2,
        min: 0,
        max: 12,
    }),
    ...
    NUMBER('style.layout.dataLabels.yAxis.offsetX', {
        def: 0,
        min: -100,
        max: 100,
    }),
    NUMBER('style.layout.dataLabels.yAxis.offsetY', {
        def: 0,
        min: -100,
        max: 100,
    }),
    NUMBER('style.layout.dataLabels.yAxis.roundingValue', {
        def: 2,
        min: 0,
        max: 12,
    }),
    ...
    SELECT('style.tooltip.position', ['left', 'center', 'right'], {
        def: 'center',
    }),
    ...
    TEXT('table.translations.correlationCoefficient', {
        def: 'Correlation coef.',
    }),
