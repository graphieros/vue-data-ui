...
const model = createModel([
    ...
    SELECT('style.line.strokeLinecap', ['round', 'square', 'butt'], {
        def: 'round',
    }),
    SELECT(
        'style.line.strokeLinejoin',
        ['round', 'bevel', 'arcs', 'miter', 'miter-clip'],
        { def: 'round' },
    ),
    ...
    SELECT('style.trendLabel.trendType', ['n-1', 'global', 'lastToFirst'], {
        def: 'global',
    }),
...
<template>
    ...
    <Box comp="VueUiSparkTrend" :dataset="datasets.positive" :config="config">
        ...
        <template #theme>
            <LocalVueUiSparkTrend
                :dataset="datasets.negative"
                :config="configTheme"
            />
            <LocalVueUiSparkTrend
                :dataset="datasets.neutral"
                :config="configTheme"
            />
            <LocalVueUiSparkTrend
                :dataset="datasets.positive"
