...
const model = createModel([
    ...
    CHECKBOX('style.chart.zoom.keepState', { def: true }),
    ...
    NUMBER('style.chart.bars.totalValues.offsetY', {
        def: 6,
        min: -100,
        max: 100,
    }),
    NUMBER('style.chart.bars.totalValues.offsetX', {
        def: 6,
        min: -100,
        max: 100,
    }),
    NUMBER('style.chart.bars.totalValues.fontSize', {
        def: 16,
        min: 8,
        max: 42,
    }),
    ...
    CHECKBOX('style.chart.bars.dataLabels.adaptColorToBackground', {
        def: true,
    }),
    COLOR('style.chart.bars.dataLabels.color', { def: '#FFFFFF' }),
    NUMBER('style.chart.bars.dataLabels.fontSize', {
        def: 14,
        min: 8,
        max: 42,
    }),
    ...
    NUMBER('style.chart.bars.dataLabels.hideUnderValue', {
        def: null,
        min: 0,
        max: 100,
    }),
    NUMBER('style.chart.bars.dataLabels.hideUnderPercentage', {
        def: null,
        min: 0,
        max: 100,
    }),
