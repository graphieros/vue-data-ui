...
const model = createModel([
    ...
    NUMBER('style.chart.plots.opacity', {
        def: 0.5,
        min: 0,
        max: 1,
        step: 0.01,
    ...
    NUMBER('style.chart.labels.bestPlotLabel.fontSize', {
        def: 14,
        min: 8,
        max: 48,
    }),
    COLOR('style.chart.labels.bestPlotLabel.color', { def: '#1A1A1A' }),
    NUMBER('style.chart.labels.bestPlotLabel.rounding', {
        def: 2,
        min: 0,
        max: 12,
    }),
    NUMBER('style.chart.labels.bestPlotLabel.offsetY', {
        def: 0,
        min: -100,
        max: 100,
    }),
    ...
    <Box comp="VueUiStripPlot" :dataset="dataset" :config="config">
        ...
        <template #local>
            <LocalVueUiStripPlot
                ...
                ref="local"
            >
                <template #optionLabels> SHOW LABELS </template>
                <template #svg="{ svg }">
