...
const model = createModel([
    ...
    NUMBER('style.chart.layout.rects.borderRadius', {
        def: 12,
        min: 0,
        max: 24,
    }),
    NUMBER('style.chart.layout.rects.colorRatio', {
        def: 0.3,
        min: 0,
        max: 1,
        step: 0.01,
    ...
    RANGE('style.chart.layout.rects.gradient.intensity', {
        def: 30,
        min: 0,
        max: 100,
    }),
    ...
    NUMBER('style.chart.layout.rects.selected.strokeWidth', {
        def: 1,
        min: 0,
        max: 12,
    }),
    RANGE('style.chart.layout.rects.selected.unselectedOpacity', {
        def: 0.6,
        min: 0,
        max: 1,
        step: 0.01,
    ...
    NUMBER('style.chart.layout.rects.group.strokeWidth', {
        def: 1,
        min: 0,
        max: 12,
    }),
    CHECKBOX('style.chart.layout.rects.group.useSeriesBackgroundColor', {
        def: true,
    }),
    NUMBER('style.chart.layout.rects.group.backgroundLighterRatio', {
        def: 0.4,
        min: 0,
        max: 1,
        step: 0.01,
    }),
    CHECKBOX('style.chart.layout.rects.group.label.adaptColorToBackground', {
        def: true,
    }),
    ...
    RANGE('style.chart.layout.labels.minFontSize', {
        def: 10,
        min: 6,
        max: 48,
        step: 1,
    }),
    NUMBER('style.chart.layout.labels.hideUnderProportion', {
        def: 0.03,
        min: 0,
        max: 1,
        step: 0.01,
    ...
    TEXT('style.chart.title.subtitle.text', {
        def: 'Lorem ipsum dolor sic amet titulum subtitulum',
    }),
    ...
    <Box comp="VueUiTreemap" :dataset="dataset" :config="config">
        ...
        <template #local>
            ...
            >
                ...
                <template
                    #rect="{ rect, shouldShow, fontSize, isZoom, textColor }"
                >
                    #RECT
