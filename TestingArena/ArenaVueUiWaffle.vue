...
const model = createModel([
    ...
    CHECKBOX('style.chart.layout.labels.captions.serieNameAbbreviation', {
        def: true,
    }),
    NUMBER('style.chart.layout.labels.captions.serieNameMaxAbbreviationSize', {
        def: 3,
        min: 0,
        max: 12,
    }),
    RANGE('style.chart.layout.labels.captions.fontSize', {
        def: 12,
        min: 8,
        max: 48,
    }),
    CHECKBOX('style.chart.layout.labels.captions.showValue', { def: true }),
    CHECKBOX('style.chart.layout.labels.captions.showPercentage', {
        def: true,
    }),
    RANGE('style.chart.layout.labels.captions.roundingValue', {
        def: 2,
        min: 0,
        max: 12,
    }),
    RANGE('style.chart.layout.labels.captions.roundingPercentage', {
        def: 2,
        min: 0,
        max: 12,
    }),
    NUMBER('style.chart.layout.labels.captions.offsetX', {
        def: 0,
        min: -100,
        max: 100,
    }),
    NUMBER('style.chart.layout.labels.captions.offsetY', {
        def: 0,
        min: -100,
        max: 100,
    }),
    ...
    RANGE('style.chart.layout.rect.gradientIntensity', {
        def: 40,
        min: 0,
        max: 100,
    }),
    ...
    RANGE('style.chart.tooltip.roundingPercentage', {
        def: 0,
        min: 0,
        max: 12,
    }),
