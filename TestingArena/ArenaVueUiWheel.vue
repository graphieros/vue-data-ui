...
const model = createModel([
    ...
    NUMBER('style.chart.animation.speed', {
        def: 0.5,
        min: 0,
        max: 2,
        step: 0.01,
    }),
    NUMBER('style.chart.animation.acceleration', {
        def: 1,
        min: 0,
        max: 10,
        step: 0.1,
    ...
    NUMBER('style.chart.layout.wheel.radiusRatio', {
        def: 0.9,
        min: 0.1,
        max: 1,
        step: 0.01,
    }),
    RANGE('style.chart.layout.wheel.tiltAngle3d', {
        def: 50,
        min: 10,
        max: 80,
    }),
    ...
    RANGE('style.chart.layout.wheel.ticks.sizeRatio', {
        def: 0.85,
        min: 0,
        max: 1,
        step: 0.01,
    ...
    RANGE('style.chart.layout.wheel.ticks.gradient.shiftHueIntensity', {
        def: 12,
        min: 0,
        max: 100,
    }),
    RANGE('style.chart.layout.wheel.ticks.quantity', {
        def: 100,
        min: 1,
        max: 1000,
    }),
    RANGE('style.chart.layout.wheel.ticks.strokeWidth', {
        def: 0,
        min: 0.1,
        max: 12,
        step: 0.1,
    ...
    SELECT('style.chart.layout.wheel.ticks.type', ['classic', 'arc'], {
        def: 'arc',
    }),
    NUMBER('style.chart.layout.wheel.ticks.spacingRatio3d', {
        def: 0.8,
        min: 0.1,
        max: 1,
        step: 0.1,
    }),
    NUMBER('style.chart.layout.wheel.ticks.shadeColorRatio3d', {
        def: 0.15,
        min: 0.1,
        max: 1,
        step: 0.1,
    }),
    RANGE('style.chart.layout.wheel.ticks.depth3d', {
        def: 100,
        min: 0,
        max: 20,
    }),
    ...
    RANGE('style.chart.layout.innerCircle.strokeWidth', {
        def: 1,
        min: 0,
        max: 48,
    }),
    NUMBER('style.chart.layout.innerCircle.radiusRatio', {
        def: 0.9,
        min: 0,
        max: 2,
        step: 0.1,
    ...
    RANGE('style.chart.layout.percentage.fontSize', {
        def: 80,
        min: 8,
        max: 100,
    }),
    RANGE('style.chart.layout.percentage.rounding', {
        def: 1,
        min: 0,
        max: 12,
    }),
    CHECKBOX('style.chart.layout.percentage.bold', { def: true }),
    NUMBER('style.chart.layout.percentage.offsetX', {
        def: 12,
        min: -100,
        max: 100,
    }),
    NUMBER('style.chart.layout.percentage.offsetY', {
        def: -16,
        min: -100,
        max: 100,
    }),
    COLOR('style.chart.layout.percentage.stroke', { def: '#FFFFFF' }),
    NUMBER('style.chart.layout.percentage.strokeWidth', {
        def: 6,
        min: 0,
        max: 12,
    }),
