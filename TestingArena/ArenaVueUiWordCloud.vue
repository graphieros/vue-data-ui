...
<template>
    ...
    <Box>
        ...
        <template #local>
            <LocalVueUiWordCloud :dataset="dataset" :config="config" :key="`local_${step}`">
                <template #svg="{ svg }">
        ...
        <template #VDUI-local>
            <LocalVueDataUi component="VueUiWordCloud" :dataset="dataset" :config="config" :key="`VDUI-lodal_${step}`">
                <template #svg="{ svg }">
                    <circle :cx="svg.width / 2" :cy="svg.height / 2" :r="30" fill="#42d392" />
                    <text :x="svg.width / 2" :y="svg.height / 2" text-anchor="middle">#SVG</text>
                </template>
        ...
        <template #build>
            <VueUiWordCloud :dataset="dataset" :config="config" :key="`build_${step}`">
                <template #svg="{ svg }">
                    <circle :cx="svg.width / 2" :cy="svg.height / 2" :r="30" fill="#42d392" />
                    <text :x="svg.width / 2" :y="svg.height / 2" text-anchor="middle">#SVG</text>
                </template>
        ...
        <template #VDUI-build>
            <VueDataUi component="VueUiWordCloud" :dataset="dataset" :config="config" :key="`VDUI-build_${step}`">
                <template #svg="{ svg }">
                    <circle :cx="svg.width / 2" :cy="svg.height / 2" :r="30" fill="#42d392" />
                    <text :x="svg.width / 2" :y="svg.height / 2" text-anchor="middle">#SVG</text>
                </template>
