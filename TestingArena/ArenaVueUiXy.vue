...
const dataset = ref([
    ...
    {
        name: 'Serie 3',
        series: [100, 200, 300, 400, 100, 200, 300, 400],
        type: 'line',
        dashed: false,
        useTag: 'end',
        dataLabels: true,
...
const model = ref([
    ...
    { key: 'chart.grid.labels.yAxis.gap', def: 64, min: 0, max: 200, type: 'number'},
...
<template>
    ...
    <Box>
        ...
        <template #local>
            <LocalVueUiXy :dataset="dataset" :config="config" :key="`local_${step}`" @selectLegend="selectLegend" @selectX="selectX">
                <template #svg="{ svg }">
        ...
        <template #VDUI-local>
            <LocalVueDataUi component="VueUiXy" :dataset="dataset" :config="config" :key="`VDUI-lodal_${step}`" @selectLegend="selectLegend" @selectX="selectX">
                <template #svg="{ svg }">
                    <circle :cx="svg.width / 2" :cy="svg.height / 2" :r="30" fill="#42d392" />
                    <text :x="svg.width / 2" :y="svg.height / 2" text-anchor="middle">#SVG</text>
                </template>
        ...
        <template #build>
            <VueUiXy :dataset="dataset" :config="config" :key="`build_${step}`" @selectLegend="selectLegend" @selectX="selectX">
                <template #svg="{ svg }">
                    <circle :cx="svg.width / 2" :cy="svg.height / 2" :r="30" fill="#42d392" />
                    <text :x="svg.width / 2" :y="svg.height / 2" text-anchor="middle">#SVG</text>
                </template>
        ...
        <template #VDUI-build>
            <VueDataUi component="VueUiXy" :dataset="dataset" :config="config" :key="`VDUI-build_${step}`" @selectLegend="selectLegend" @selectX="selectX">
                <template #svg="{ svg }">
                    <circle :cx="svg.width / 2" :cy="svg.height / 2" :r="30" fill="#42d392" />
                    <text :x="svg.width / 2" :y="svg.height / 2" text-anchor="middle">#SVG</text>
                </template>
