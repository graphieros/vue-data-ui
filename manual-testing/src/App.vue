...
const components = [
    ...
    {
        name: 'ArenaVueUiParallelCoordinatePlot',
    ...
    { name: 'ArenaVueUiBump', icon: 'chartBump' },
    { name: 'ArenaVueUiHill', icon: 'chartHill' },
].map((componentItem) => ({
            ...
            <nav>
                <div class="sticked">
                    <div class="nav-header">
                        ...
                        <code style="text-align: right; margin-top: -0.7rem"
                            >vue-data-ui {{ CURRENT_PACKAGE.version }}</code
                        >
