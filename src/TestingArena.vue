        ...
        nodes: [
            {
                ...
                nodes: [
                    ...
                    {
                        name: 'node1.3',
                        nodes: [{ name: 'node1.1' }, { name: 'node1.2' }],
                    },
                    {
                        name: 'node1.4',
                        nodes: [
...
<template>
    ...
    >
        ...
        >
            ...
            <div>
                <h1 style="font-size: 36px; color: #42d392">Vue Data UI</h1>
        ...
        <Box @copy="copyConfig(PROD_CONFIG.vue_ui_quick_chart)">
            ...
            <template #prod>
                <VueDataUi
                    ...
                    :dataset="quickDatasetDonut"
                    :config="quickConfig"
                />
                <VueUiQuickChart
                    :dataset="quickDatasetLine"
                    :config="quickConfig"
                />
                <VueUiQuickChart
                    :dataset="quickDatasetSimpleLine"
                    ...
                    <template #content>
                        ...
                        >
                            <template #legend="{ legend }">
                                ...
                                >
                                    <div
                                        :style="`opacity: ${item.isSegregated ? '0.3' : '1'}`"
                                    >
          ...
          <BaseIcon name="fullscreen" stroke="#5f8bee"/> -->
            ...
            <template #dev>
                <VueDataUiTest
                    ...
                    :dataset="tableHeatmapDataset"
                    :config="tableHeatmapConfig"
                >
                    <template #caption>
                        <div style="width: 100%; background: red">TITLE</div>
                    </template>
                    ...
                    >
                        <div
                            :style="`height: 40px; display: flex; align-items:center; justify-content: flex-end; padding: 0 6px;font-weight:${isResponsive ? 'bold' : 'normal'}`"
                        >
                            {{ value }}
                        </div>
                    </template>
        ...
        <Box @copy="copyConfig(PROD_CONFIG.vue_ui_treemap)">
            ...
            <template #dev>
                <TreemapTest
                    ...
                    @selectLegend="treemapSelect"
                    @selectDatapoint="treemapSelect"
                >
                </TreemapTest>
            </template>
            <template #prod>
        ...
        <Box @copy="copyConfig(PROD_CONFIG.vue_ui_sparkgauge)">
            ...
            <template #dev>
                <VueDataUiTest
                    ...
                    :dataset="sparkGaugeDataset"
                    :config="sparkGaugeConfig"
                />
            </template>
            <template #prod>
                <VueDataUi
        ...
        <Box @copy="copyConfig(PROD_CONFIG.vue_ui_nested_donuts)">
            ...
            <template #dev>
                <VueDataUiTest
                    ...
                    :dataset="nestedDonutsDataset"
                    :config="nestedDonutsConfig"
                >
                    <template
                        #tooltip-before="{
                            seriesIndex,
                    ...
                    <template #legend="{ legend }">
                        <div v-for="legendSets in legend">
                            <div
                                v-for="l in legendSets"
                                :style="`opacity: ${l.isSegregated ? '0.3' : '1'}`"
                                @click="l.segregate()"
                            >
                                {{ l.name }} {{ l.color }}
                            </div>
        ...
        <Box @copy="copyConfig(PROD_CONFIG.vue_ui_mood_radar)">
            ...
            <template #dev>
                <VueDataUiTest
                    ...
                    :dataset="moodRadarDataset"
                    :config="moodRadarConfig"
                >
                    <template #svg="{ svg }">
                        <circle
                            :cx="svg.width / 2"
        ...
        <Box @copy="copyConfig(PROD_CONFIG.vue_ui_digits)">
            ...
            <template #dev>
                <VueDataUiTest
                    ...
                    :config="{
                        backgroundColor: '#1A1A1A',
                        digits: { color: '#42d392', skeletonColor: '#2A2A2A' },
                    }"
                />
            </template>
            <template #prod>
        ...
        <Box @copy="copyConfig(PROD_CONFIG.vue_ui_donut_evolution)">
            ...
            <template #dev>
                ...
                >
                    ...
                    <template #svg="{ svg }">
                        <circle
                            :cx="svg.absoluteWidth / 2"
                            :cy="svg.absoluteHeight / 2"
                            :r="30"
                            fill="#FF000033"
                        />
                    </template>
        ...
        <Box @copy="copyConfig(PROD_CONFIG.vue_ui_skeleton)">
            ...
            <template #dev>
                <VueDataUiTest
                    ...
                    :config="{
                        type: skeletonChoice,
                        style: { rating: { useSmiley: true, filled: true } },
                    }"
                />
            </template>
            <template #prod>
            ...
            <template #dev>
                ...
                >
                    ...
                    >
                        <div
                            v-if="isVisible"
                            :style="`background: ${datapoint.color}30; border: 1px solid ${datapoint.color};text-align:${textAlign};display:flex; place-items:center; justify-content:flex-${flexAlign}`"
                        >
                            <VueUiIcon
                                name="chartDonut"
        ...
        <Box @copy="copyConfig(PROD_CONFIG.vue_ui_dashboard)">
            ...
            <template #dev>
                ...
                <VueDataUiTest
                    ...
                    :config="dashboardConfig"
                >
                    <template #top="{ item }"> TOP CONTENT </template>
                    <template #bottom="{ item }"> BOTTOM CONTENT </template>
                    <template v-slot:content="{ item }">
                        <div style="padding: 12px">
                            LOREM IPSUM
                            <component
        ...
        <Box @copy="copyConfig(PROD_CONFIG.vue_ui_table)">
            ...
            <template #prod>
                <VueDataUi component="VueUiTable" :dataset="tableTestDataset" />
            </template>
            <template #config>
