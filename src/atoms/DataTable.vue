...
<template>
    ...
    >
        <div
            ...
            role="button"
            tabindex="0"
            :style="`width:32px; position: absolute; top: 0; right:4px; padding: 0 0px; display: flex; align-items:center;justify-content:center;height: 36px; width: 32px; cursor:${isCursorPointer ? 'pointer' : 'default'}; background:${thbg};`"
            @click="emit('close')"
        ...
        <table data-cy="vue-data-ui-table-data" class="vue-ui-data-table">
            <caption
                :style="{ backgroundColor: thbg, color: thc, outline: tho }"
            ...
            <thead>
                <tr
                    ...
                    :style="{ backgroundColor: thbg, color: thc }"
                >
                    <th
                        role="cell"
                        :style="{
            ...
            <tbody>
                <tr
                    ...
                    :style="{ backgroundColor: tdbg, color: tdc }"
                >
                    <td
                        role="cell"
                        v-for="(td, j) in tr"
                        :data-cell="
                            (colNames[j] && colNames[j].name
                                ? colNames[j].name
                                : '') ||
                            colNames[j] ||
                            ''
