...
describe('<UserOptions />', () => {
    ...
    function open() {
        ...
        cy.get(`[data-cy="user-options-drawer"]`)
            .should('exist')
            .and('be.visible');
    }
    ...
    it('displays labels in tooltips', () => {
        ...
        cy.mount(UserOptions, {
            ...
            cy.get('[data-cy="user-options-tooltip"]')
                .trigger('mouseenter')
                .then(() => {
                    cy.get('[data-cy="uo-tooltip"]')
                        .should('be.visible')
                        .and('contain', 'tooltip');
                    cy.get('[data-cy="user-options-tooltip"]').trigger(
                        'mouseout',
                    );
                });
            cy.get('[data-cy="user-options-pdf"]')
            ...
            cy.get('[data-cy="user-options-table"]')
                ...
                .then(() => {
                    cy.get('[data-cy="uo-tooltip"]')
                        .should('be.visible')
                        .and('contain', 'table');
                    cy.get('[data-cy="user-options-table"]').trigger(
                        'mouseout',
                    );
                });
            cy.get('[data-cy="user-options-label"]')
                ...
                .then(() => {
                    cy.get('[data-cy="uo-tooltip"]')
                        .should('be.visible')
                        .and('contain', 'labels');
                    cy.get('[data-cy="user-options-label"]').trigger(
                        'mouseout',
                    );
                });
            cy.get('[data-cy="user-options-sort"]')
            ...
            cy.get('[data-cy="user-options-stack"]')
                ...
                .then(() => {
                    cy.get('[data-cy="uo-tooltip"]')
                        .should('be.visible')
                        .and('contain', 'stack');
                    cy.get('[data-cy="user-options-stack"]').trigger(
                        'mouseout',
                    );
                });
            cy.get('[data-cy="user-options-fullscreen"]')
                ...
                .then(() => {
                    ...
                    cy.get('[data-cy="user-options-fullscreen"]').trigger(
                        'mouseout',
                    );
                });
            cy.get('[data-cy="user-options-anim"]')
            ...
            cy.get('[data-cy="user-options-annotator"]')
                ...
                .then(() => {
                    cy.get('[data-cy="uo-tooltip"]')
                        .should('be.visible')
                        .and('contain', 'annotator');
                    cy.get('[data-cy="user-options-annotator"]').trigger(
                        'mouseout',
                    );
                });
            cy.get('[data-cy="user-options-svg"]')
