...
describe('<VueUiAgePyramid />', () => {
    it('renders', () => {
        ...
        cy.mount(VueUiAgePyramid, {
            ...
            cy.log('labels');
            cy.get('[data-cy="label-left"]')
                .should('exist')
                .and('be.visible')
                .and('contain', 'female');
            cy.get('[data-cy="label-right"]')
                .should('exist')
                .and('be.visible')
                .and('contain', 'male');
            ...
            cy.get('[data-cy="scale-tick-left"]')
                .should('exist')
                .and('have.length', 6);
            cy.get('[data-cy="scale-tick-right"]')
                .should('exist')
                .and('have.length', 6);
            cy.get('[data-cy="scale-tick-left-label"]')
                .as('labelsLeft')
                .should('exist')
                .and('have.length', 6);
            cy.get('[data-cy="scale-tick-right-label"]')
                .as('labelsRight')
                .should('exist')
                .and('have.length', 6);
