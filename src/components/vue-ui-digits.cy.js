...
describe('<VueUiDigits />', () => {
    ...
    it('renders 0', () => {
        ...
        cy.mount(VueUiDigits, {
            ...
            cy.get('[data-cy="digit-a"]')
                .should('exist')
                .and('be.visible')
                .invoke('attr', 'fill')
                .should('eq', '#000000ff');
            cy.get('[data-cy="digit-b"]')
                .should('exist')
                .and('be.visible')
                .invoke('attr', 'fill')
                .should('eq', '#000000ff');
            cy.get('[data-cy="digit-c"]')
                .should('exist')
                .and('be.visible')
                .invoke('attr', 'fill')
                .should('eq', '#000000ff');
            cy.get('[data-cy="digit-d"]')
                .should('exist')
                .and('be.visible')
                .invoke('attr', 'fill')
                .should('eq', '#000000ff');
            cy.get('[data-cy="digit-e"]')
                .should('exist')
                .and('be.visible')
                .invoke('attr', 'fill')
                .should('eq', '#000000ff');
            cy.get('[data-cy="digit-f"]')
                .should('exist')
                .and('be.visible')
                .invoke('attr', 'fill')
                .should('eq', '#000000ff');
            cy.get('[data-cy="digit-g"]')
                .should('exist')
                .and('be.visible')
                .invoke('attr', 'fill')
                .should('eq', '#CCCCCC');
