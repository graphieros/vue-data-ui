...
function useTooltip({ datapoint, relativeIndex, seriesIndex, show = false, triggerMode = 'pointer' }) {
...
function arcLabel(arc) {
    return buildLabel({
        ...
        showPercentage: FINAL_CONFIG.value.style.chart.layout.labels.percentage.show,
