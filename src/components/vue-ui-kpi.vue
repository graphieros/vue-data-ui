...
const formattedValue = ref(
    typeof props.dataset === 'number' ? props.dataset : props.dataset,
);
const displayedValue = ref(
    FINAL_CONFIG.value.useAnimation
        ? FINAL_CONFIG.value.animationValueStart
    ...
    >
        ...
        >
            ...
            <template v-if="FINAL_CONFIG.analogDigits.show">
                <div
                    :style="{ height: FINAL_CONFIG.analogDigits.height + 'px' }"
                >
                    <Digits
                        :dataset="
                            Number(
                                displayedValue.toFixed(
                                    FINAL_CONFIG.valueRounding,
                                ),
                            )
                        "
                        :config="{
                            ...
                            digits: {
                                ...
                                skeletonColor:
                                    FINAL_CONFIG.analogDigits.skeletonColor,
                            },
                        }"
                    />
                </div>
