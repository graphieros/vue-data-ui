    ...
    it('renders', () => {
        cy.get('@fixture').then((fixture) => {
            ...
            [
                ...
                cy.get(el.selector).should('exist').contains(el.expected);
            });
                ...
                [
                    {
                        attr: 'r',
                        expected: String(
                            fixture.config.style.size *
                                fixture.config.style.circle.radiusProportion,
                        ),
                    },
                    {
                        attr: 'cx',
                    ...
                    },
                    {
                        attr: 'cy',
                        expected: String(
                            fixture.config.style.size / 2 +
                                fixture.config.style.circle.offsetY,
                        ),
                    },
                    {
                        attr: 'stroke',
                    ...
                    },
                    {
                        attr: 'stroke-width',
                        expected: String(
                            fixture.config.style.circle.strokeWidth,
                        ),
                    },
                ].forEach((el) => {
                    cy.wrap($circle)
