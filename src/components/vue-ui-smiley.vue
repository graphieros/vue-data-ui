...
function getActiveColor(index) {
    if (ratingConfig.value.readonly) {
        return ratingConfig.value.style.colors.inactive[index]
    } else {
        if (currentRating.value === index + 1) {
            if (ratingConfig.value.style.icons.useGradient && ratingConfig.value.style.icons.filled) {
                    return `url(#vueUiSmiley${index})`;
                }
                return ratingConfig.value.style.colors.active[index];
        } else {
                ...
                <svg v-if="ratingConfig.style.icons.filled" style="transition: all 0.1s ease-in-out;position:absolute;top:0;left:0" height="100%" viewBox="0 0 24 24" stroke-width="1.5" :stroke="getActiveColor(0)" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <defs>
                        <radialGradient id="vueUiSmiley0">
                            ...
                            <stop offset="100%" :stop-color="ratingConfig.style.colors.active[0]"/>
                        </radialGradient>
                    </defs>
                ...
                <svg v-if="ratingConfig.style.icons.filled && isReadonly" style="transition: all 0.1s ease-in-out;position:absolute;top:0;left:0" height="100%" :viewBox="`0 0 ${calcShapeFill(0)} 24`" stroke-width="1.5" :stroke="ratingConfig.style.colors.activeReadonly[0]" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <defs>
                        <radialGradient id="vueUiSmiley0">
                            ...
                            <stop offset="100%" :stop-color="ratingConfig.style.colors.activeReadonly[0]"/>
                        </radialGradient>
                    </defs>
                <path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M17 3.34a10 10 0 1 1 -14.995 8.984l-.005 -.324l.005 -.324a10 10 0 0 1 14.995 -8.336zm-5 9.86a4.5 4.5 0 0 0 -3.214 1.35a1 1 0 1 0 1.428 1.4a2.5 2.5 0 0 1 3.572 0a1 1 0 0 0 1.428 -1.4a4.5 4.5 0 0 0 -3.214 -1.35zm-2.99 -4.2l-.127 .007a1 1 0 0 0 0 1.986l.117 .007l.127 -.007a1 1 0 0 0 0 -1.986l-.117 -.007zm6 0l-.127 .007a1 1 0 0 0 0 1.986l.117 .007l.127 -.007a1 1 0 0 0 0 -1.986l-.117 -.007z" stroke-width="0" :fill="ratingConfig.style.icons.useGradient ? `url(#vueUiSmiley0)` : ratingConfig.style.colors.activeReadonly[0]" /></svg>

                <svg v-if="!ratingConfig.style.icons.filled && isReadonly" style="position:absolute;top:0;left:0;transition: all 0.1s ease-in-out;" height="100%" :viewBox="`0 0 ${calcShapeFill(0)} 24`" stroke-width="1.5" :stroke="ratingConfig.style.colors.activeReadonly[0]" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 12m-9 0a9 9 0 1 0 18 0a9 9 0 1 0 -18 0" /><path d="M9 10l.01 0" /><path d="M15 10l.01 0" /><path d="M9.5 15.25a3.5 3.5 0 0 1 5 0" /></svg>
            </div>
                ...
                <svg v-if="ratingConfig.style.icons.filled" style="position:absolute;top:0;left:0;transition: all 0.1s ease-in-out" height="100%" viewBox="0 0 24 24" stroke-width="1.5" :stroke="getActiveColor(1)" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <defs>
                        <radialGradient id="vueUiSmiley1">
                            ...
                            <stop offset="100%" :stop-color="ratingConfig.style.colors.active[1]"/>
                        </radialGradient>
                    </defs>
                ...
                <svg v-if="ratingConfig.style.icons.filled && isReadonly" style="position:absolute;top:0;left:0;transition: all 0.1s ease-in-out" height="100%" :viewBox="`0 0 ${calcShapeFill(1)} 24`" stroke-width="1.5" :stroke="ratingConfig.style.colors.activeReadonly[1]" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <defs>
                        <radialGradient id="vueUiSmiley1">
                            ...
                            <stop offset="100%" :stop-color="ratingConfig.style.colors.activeReadonly[1]"/>
                        </radialGradient>
                    </defs>
                <path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M17 3.34a10 10 0 1 1 -14.995 8.984l-.005 -.324l.005 -.324a10 10 0 0 1 14.995 -8.336zm-2 10.66h-6l-.117 .007a1 1 0 0 0 0 1.986l.117 .007h6l.117 -.007a1 1 0 0 0 0 -1.986l-.117 -.007zm-5.99 -5l-.127 .007a1 1 0 0 0 0 1.986l.117 .007l.127 -.007a1 1 0 0 0 0 -1.986l-.117 -.007zm6 0l-.127 .007a1 1 0 0 0 0 1.986l.117 .007l.127 -.007a1 1 0 0 0 0 -1.986l-.117 -.007z" stroke-width="0" :fill="ratingConfig.style.icons.useGradient ? `url(#vueUiSmiley1)` : ratingConfig.style.colors.activeReadonly[1]"/></svg>

                <svg v-if="!ratingConfig.style.icons.filled && isReadonly" style="position:absolute;top:0;left:0;transition: all 0.1s ease-in-out" height="100%" :viewBox="`0 0 ${calcShapeFill(1)} 24`" stroke-width="1.5" :stroke="ratingConfig.style.colors.activeReadonly[1]" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 12m-9 0a9 9 0 1 0 18 0a9 9 0 1 0 -18 0" /><path d="M9 10l.01 0" /><path d="M15 10l.01 0" /><path d="M9 15l6 0" /></svg>
            </div>
                ...
                <svg v-if="ratingConfig.style.icons.filled" style="position:absolute;top:0;left:0;transition: all 0.1s ease-in-out" height="100%" viewBox="0 0 24 24" stroke-width="1.5" :stroke="getActiveColor(2)" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <defs>
                        <radialGradient id="vueUiSmiley2">
                            ...
                            <stop offset="100%" :stop-color="ratingConfig.style.colors.activeReadonly[2]"/>
                        </radialGradient>
                    </defs>
                ...
                <svg v-if="ratingConfig.style.icons.filled" style="position:absolute;top:0;left:0;transition: all 0.1s ease-in-out" height="100%" viewBox="0 0 24 24" stroke-width="1.5" :stroke="getActiveColor(3)" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <defs>
                        <radialGradient id="vueUiSmiley3">
                            ...
                            <stop offset="100%" :stop-color="ratingConfig.style.colors.activeReadonly[3]"/>
                        </radialGradient>
                    </defs>
                ...
                <svg v-if="ratingConfig.style.icons.filled" style="position:absolute;top:0;left:0;transition: all 0.1s ease-in-out" height="100%" viewBox="0 0 24 24" stroke-width="1.5" :stroke="getActiveColor(4)"  fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <defs>
                        <radialGradient id="vueUiSmiley4">
                            ...
                            <stop offset="100%" :stop-color="ratingConfig.style.colors.activeReadonly[4]"/>
                        </radialGradient>
                    </defs>
