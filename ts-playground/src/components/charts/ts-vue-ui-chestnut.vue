...
/**
 * This playground showcases all the slots and their implementations for <VueUiChestnut>
 */
...
const dataset = computed<VueUiChestnutDatasetRoot[]>(() => {
    return [
        {
            name: 'Root1',
            color: '#ff6400',
...
const config = computed<VueUiChestnutConfig>(() => {
    return mergeConfigs({
