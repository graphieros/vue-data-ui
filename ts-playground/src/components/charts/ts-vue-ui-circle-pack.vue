...
/**
 * This playground showcases all the slots and their implementations for <VueUiCirclePack>
 */
...
import CirclePackSvg from '../slots/vue-ui-circle-pack/circle-pack-svg.vue';
...
import CirclePackTooltip from '../slots/vue-ui-circle-pack/circle-pack-tooltip.vue';
import Skeleton from '../slots/common/skeleton.vue';

const dataset = computed<VueUiCirclePackDatasetItem[]>(() => {
    return [
        {
            name: 'A',
            value: 384,
...
const config = computed<VueUiCirclePackConfig>(() => {
    return mergeConfigs({
...
<template>
    <div>
        <VueUiCirclePack :dataset :config>
            ...
            <template #data-label="label">
                <CirclePackDataLabel :label />
            </template>

            <template #circle="circle">
                <CirclePackCircle :circle />
            </template>
            ...
            <template #tooltip="{ datapoint, seriesIndex }">
                <CirclePackTooltip :datapoint :series-index />
            </template>
